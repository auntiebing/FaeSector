...
public class fae_calathAI implements MissileAIPlugin, GuidedMissileAI
{
    //////////////////////
    //     SETTINGS     //
    //////////////////////
    ...
    public fae_calathAI(MissileAPI missile, ShipAPI launchingShip) {
    ...
    public void advance(float amount) {
        ...
        if(launch || timer>=check){
            ...
            lead = AIUtils.getBestInterceptPoint(
                    missile.getLocation(),
                    MAX_SPEED*ECCM, //if eccm is installed the point is accurate, otherwise it's placed closer to the target (almost tail-chasing)
                    target.getLocation(),
                    target.getVelocity()
            );                
