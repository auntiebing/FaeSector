...
public class fae_AMMAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public fae_AMMAI(MissileAPI missile, ShipAPI launchingShip) {
                ...
                for (MissileAPI m : near) {
                    ...
                    if (m.getOwner() == missile.getOwner()) {
                        if (m.getWeaponSpec() != null && m.getWeaponSpec().getWeaponId().equals(missile.getWeaponSpec().getWeaponId())) {
                            if (m.getMissileAI() instanceof bing.faesector.data.weapons.fae_AMMAI) {
                                bing.faesector.data.weapons.fae_AMMAI ai = (bing.faesector.data.weapons.fae_AMMAI) m.getMissileAI();
